...
const steps = [
  ...
  },
  {
    icon: Truck,
    title: "Deliver Fresh",
    description: "Your sneakers are returned in luxury packaging, looking brand new and protected for the future.",
  ...
  },
  {
    ...
    description: "Wear your revitalized sneakers with confidence, it's like having a brand new pair.",
    time: "The Best Part",
    color: "from-primary to-accent",
  }
]
      ...
      <div className="container mx-auto relative z-10">
        <div className="text-center mb-20">
          ...
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
            Every pair receives our signature treatment - a meticulous process refined over years of expertise
          </p>
        </div>
