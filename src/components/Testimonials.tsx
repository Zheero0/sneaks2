      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {testimonials.map((testimonial, index) => (
            <Card
              key={index}
              className="group gradient-border-bg hover-lift"
            >
              ...
              <CardContent className="p-8 relative z-10">
                ...
                <div className="flex items-center mb-6">
                  ...
                  {testimonial.verified && (
                    <div className="ml-3 text-xs bg-primary/20 text-primary px-2 py-1 rounded-full">Verified</div>
                  )}
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="relative">
                    <div className="absolute inset-0 bg-gradient-to-r from-primary to-accent rounded-full blur-sm opacity-50 group-hover:opacity-75 transition-opacity"></div>
                    <Image
                      src={testimonial.image}
                      alt={testimonial.name}
                      width={60}
                      height={60}
                      className="relative rounded-full border-2 border-border group-hover:border-primary/50 transition-colors"
        ...
        <div className="mt-16 text-center">
          <div className="grid md:grid-cols-4 gap-8 max-w-4xl mx-auto">
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary">{siteStats.premiumRestorations}</div>
              <div className="text-sm text-muted-foreground">Premium Restorations</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary">{siteStats.clientSatisfaction}</div>
              <div className="text-sm text-muted-foreground">Client Satisfaction</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary">{siteStats.insuredService}</div>
              <div className="text-sm text-muted-foreground">Insured Service</div>
            </div>
            <div className="space-y-2">
              <div className="text-3xl font-bold text-primary">{siteStats.conciergeSupport}</div>
